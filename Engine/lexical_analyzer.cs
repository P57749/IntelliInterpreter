...
namespace HulkInterpreter
{
    public enum TokenType
    {
        ...
        Keyword         // Palabra clave (print, function, let, in, if, else, sin, cos, factorial)
    }
    ...
    public class Lexer
    {
        ...
        private bool IsKeyword(string lexeme)
        {
            ...
            string[] keywords = { "print", "function", "let", "in", "if", "else", "sin", "cos", "factorial" };
        ...
        private Token ScanIdentifierOrKeyword()
        {
            ...
            if (type == TokenType.Identifier || type == TokenType.Keyword)
            {
                return new Token(type, lexeme, line);
            }
            else
            {
                throw new LexerException($"! LEXICAL ERROR: `{lexeme}` is not a valid token.");
            }
        }
    }
